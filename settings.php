            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div id="profile_picture">
                    ...
                    <ul>
                        ...
                        <?php if($image != 'avatars/default_avatar.png'){ ?>
	                        <li>
	                            <input type="checkbox" class="form-control" name="use_default" id="use_default" /> <label for="use_default">Use default picture</label>
	                        </li>
	                        <?php 
                        }
                        ?>
            	...
            	<div id="personal_info">
	                ...
	                <ul>
	                    ...
	                    <li>
	                        <h4>Bio:</h4>
	                        <textarea class="form-control" id="bio" name="bio"><?php if (isset($_POST['bio']) ){echo htmlentities(strip_tags($_POST['bio']));} else { echo $user['bio']; }?></textarea>
	                    </li>
	            	</ul>    
            	</div>
            	<div class="clear"></div>
            	<hr />
                    ...
                    <input class="btn btn-primary btn-block" id="save" type="submit" value="Update">
            </form>
		</div>
    </div>
